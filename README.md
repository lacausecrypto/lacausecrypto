...
| [mcp-sophon](https://github.com/lacausecrypto/mcp-sophon) | Deterministic context layer for MCP agents — prompt / memory / code / delta / output compression, honest benchmarks | `67% savings` `42.5% LOCOMO N=40` `206 tests` `20 output filters` |
